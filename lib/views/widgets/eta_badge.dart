...
enum EtaType { normal, fast, long, express }

class EtaBadge extends StatelessWidget {
  const EtaBadge({super.key, required this.label, this.type = EtaType.normal});
  ...
  Color _darken(Color color, double amount) {
    ...
    final hslDark = hsl.withLightness((hsl.lightness - amount).clamp(0.0, 2.0));
