...
class _PickupScheduleScreenState extends State<PickupScheduleScreen> {
  ...
  Widget _addressOption(String key) {
    return ListTile(
      leading: const Icon(Icons.home_outlined),
      title: Text(key),
      subtitle: Text(_addresses[key]!),
      onTap: () {
        setState(() {
                ...
                child: Column(
                  ...
                  children: [
                        ...
                        child: Column(
                          children: [
                            ...
                            TextButton(
                              ...
                              child: const Text('Tambah Alamat di Profil'),
                            ),
                          ],
                        ),
                      )
                    ...
                    PrimaryButton(
                      ...
                      onPressed: () {
                        setState(() {
                          _pickupError = _pickupTime == null;
                          _deliveryError = _deliveryTime == null;
                        });
