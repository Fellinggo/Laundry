...
import '../../shared/widgets/pin_dots_indicator_widget.dart';
...
class PinEntryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider<PinEntryController>(
      create: (_) => PinEntryController(),
      child: Consumer<PinEntryController>(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: PrimaryButton(
                    ...
                    onPressed:
                        controller.isPinComplete && !controller.isProcessing
                        ? () =>
                              controller.confirmAndNavigate(context, orderData)
                        : null,
                  ),
                ),
                const Spacer(),
