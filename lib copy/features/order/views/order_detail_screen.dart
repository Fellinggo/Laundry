...
import '../../shared/widgets/order_detail_box.dart';
import '../../shared/widgets/order_detail_item_row.dart';
...
class OrderDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final args =
        ...
        {};
    final orderData = OrderDetailData.fromArguments(args);

    // Menyediakan controller menggunakan ChangeNotifierProvider agar siklus datanya reaktif
    return ChangeNotifierProvider<OrderDetailController>(
      create: (_) => OrderDetailController(data: orderData),
                        ...
                        NotificationListener<OverscrollIndicatorNotification>(
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              ...
                              children: [
                                OrderDetailBox(
                                  child: _buildStatusHeader(data, controller),
                                ),
                                const SizedBox(height: 20),

                                if (data.orderItems.isNotEmpty)
                                  OrderDetailBox(
                                    child: _buildOrderItems(data, controller),
                                  ),
                                ...
                                OrderDetailBox(
                                  child: _buildPaymentDetails(data, controller),
                                ),
                                const SizedBox(height: 20),
  ...
  Widget _buildStatusHeader(
    ...
    return Column(
      ...
      children: [
        ...
        OrderStepProgressBar(activeIndex: data.activeStepIndex),
        const SizedBox(height: 16),
        ClipRRect(
        ...
        Column(
          children: List.generate(
            ...
            (index) => const Padding(
              ...
              child: Text(
                '•',
                style: TextStyle(color: Colors.grey, fontSize: 14, height: 0.7),
              ),
            ),
          ),
        ),
  ...
  Widget _buildOrderItems(
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        ...data.orderItems.map((item) => OrderDetailItemRow(item: item)),
        ...
        Row(
          ...
          children: [
            ...
            Text(
              controller.formatRupiah(data.totalProductPrice),
  ...
  Widget _buildPaymentDetails(
    ...
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        _rowBold('Waktu Pengambilan', data.pickupTimeText),
        const Divider(),
        _rowBold('Waktu Pengiriman', data.deliveryTimeText),
        const Divider(),
        Padding(
        ...
        const SizedBox(height: 10),
        _row('Biaya Pengiriman', controller.formatRupiah(data.deliveryFee)),
        _row('Kode Promo', '-'),
        const Divider(),
        _row(
          'Total Pembayaran',
          controller.formatRupiah(data.grandTotal),
          bold: true,
        ),
      ],
    );
      ...
      child: ElevatedButton(
        onPressed: controller.isSaving
            ...
            : () async {
                ...
                await controller.onConfirmPressed(context);
              },
        ...
        child: Text(
          controller.isSaving ? 'Menyimpan...' : 'Konfirmasi Pesanan',
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(value, style: AppTextStyles.body, textAlign: TextAlign.right),
        ],
      ),
    );
  }
